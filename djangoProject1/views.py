...
# 本地导入
from .models import (
    Welcome, Banner, Notice, Index_Annonce, Category, Goods, VideoCourse, StudyCheckIn, ExamQuestion, ExamRecord, Certification,
    Cart, Recipient, Address, OrderItem, Area, VideoWatchLog
)
...
from .models import Order, SF_STATUS_MAP
...
from app01.utils.ai_utils import get_ai_answer
